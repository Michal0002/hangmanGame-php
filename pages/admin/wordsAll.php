...
<div class="container-fluid">
  <div class="row">
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      ...
      <p class="text-center"><a href="../newWord.php"> Add new word </a></p>
  ...
  <div class="table-responsive">
    <table class="table table-striped table-sm">
      ...
      <tbody>
        ...
        $query = "SELECT w.id, w.word, w.status, d.name FROM words AS w 
        ...
        if ($result->num_rows > 0) {
          while ($row = $result->fetch_assoc()) {
            ...
            echo "<tr>
                    ...
                    <td> $status </td>
                    <td><a href='editWord.php?id=" . $wordId . "'>Edit</a></td>
                  </tr>";
          }
        } else {
